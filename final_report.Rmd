...
airportdelaymap <- ggmap(usa) +
  geom_point(data=airportdelaycoords, 
             aes(x=lon,y=lat,color=avgdelay, text=ORIGIN_CITY_NAME),
             alpha=.7, size = .5,) +
...
data18 %>% 
  ...
  geom_col() +
  coord_flip() +
  labs(x = "Airline", y= "Number of early departures") +
  scale_y_continuous() +
  theme_minimal()+
...
### Link to [Shiny App](https://robert-mdh-bui.shinyapps.io/112_final_project/)
...
### Link to [Shiny App 2](https://alex-marketos.shinyapps.io/Delay_Time_App/)
