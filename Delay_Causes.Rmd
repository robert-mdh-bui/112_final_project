...
```{r}
Delay2018 %>% 
  summarize(Delay_Delay = sum(DEP_DELAY, na.rm = TRUE))
```
...
Basics %>%
  ...
  theme_minimal()+
  labs(x = "Causes of Delay", y = "Proportion of Total Deelay", title = "Cause of Delay in Minnesota versus the United States")
...
Delay_Cause_Proportions <- tibble(
  ...
  Location = c("US", "MN","US", "MN","US", "MN","US", "MN","US", "MN"),
